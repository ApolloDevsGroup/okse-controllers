        ...
        return new Promise((resolve, reject) => {
            ...
            this.hub.once(`${messageId}:finished`, (data) => {
                switch (data.status) {
                    ...
                    case 'rejected':
                        return reject(new Error('Message Signature: User denied message signature.'));
                    default:
                        return reject(new Error(`Message Signature: Unknown problem: ${JSON.stringify(messageParams)}`));
                }
            });
        });
    }
